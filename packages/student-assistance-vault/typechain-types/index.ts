...
export type { StudentAssistanceVault } from "./contracts/StudentAssistanceVault";
export { StudentAssistanceVault__factory } from "./factories/contracts/StudentAssistanceVault__factory";
