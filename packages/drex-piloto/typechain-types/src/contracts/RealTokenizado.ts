...
export interface RealTokenizadoInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ACCESS_ROLE"
      | "BURNER_ROLE"
...
export interface RealTokenizado extends BaseContract {
  connect(runner?: ContractRunner | null): RealTokenizado;
  ...
  cnpj8: TypedContractMethod<[], [bigint], "view">;
  ...
  frozenBalanceOf: TypedContractMethod<[wallet: AddressLike], [bigint], "view">;
  ...
  moveAndBurn: TypedContractMethod<
    [from: AddressLike, amount: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "frozenBalanceOf"
  ...
  ): TypedContractMethod<[newReserve: AddressLike], [void], "nonpayable">;
  getFunction(
